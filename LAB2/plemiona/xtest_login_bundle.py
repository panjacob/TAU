...
class TestPlemionaLogin(unittest.TestCase):
    ...
    def test_wrong_email_chrome(self):
        result = xtest_login_utils.test_login_wrong_username(driver_chrome())
        self.assertTrue(result)

    def test_no_email_chrome(self):
        result = xtest_login_utils.test_login_no_username(driver_chrome())
        self.assertTrue(result)
    ...
    def test_wrong_email_firefox(self):
        result = xtest_login_utils.test_login_wrong_username(driver_firefox())
        self.assertTrue(result)

    def test_no_email_firefox(self):
        result = xtest_login_utils.test_login_no_username(driver_firefox())
        self.assertTrue(result)
    ...
    def test_wrong_email_edge(self):
        result = xtest_login_utils.test_login_wrong_username(driver_edge())
        self.assertTrue(result)

    def test_no_email_edge(self):
        result = xtest_login_utils.test_login_no_username(driver_edge())
        self.assertTrue(result)
